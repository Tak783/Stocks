...
final class ConvertToCurrencyUnitTests: XCTestCase {
    func test_convertToCurrency_convertsPriceInCentsToCurrencyFormat() {
        ...
        let convertedPrice1 = ConvertToCurrency.convert(priceInCents: priceInCents1, withCurrencyCode:currencyCode1)
        ...
        let convertedPrice2 = ConvertToCurrency.convert(priceInCents: priceInCents2, withCurrencyCode:currencyCode2)
        ...
        let convertedPrice3 = ConvertToCurrency.convert(priceInCents: priceInCents3, withCurrencyCode:currencyCode3)
