...
final class NumberFormatterrCurrencyExtensionsUnitTests: XCTestCase {
    ...
    func test_convertToCurrency_convertsPriceInCentsToCurrencyFormat() {
        ...
        let convertedPrice1 = NumberFormatter.convertToCurrency(priceInCents: priceInCents1, withCurrencyCode:currencyCode1)
        ...
        let convertedPrice2 = NumberFormatter.convertToCurrency(priceInCents: priceInCents2, withCurrencyCode:currencyCode2)
        ...
        let convertedPrice3 = NumberFormatter.convertToCurrency(priceInCents: priceInCents3, withCurrencyCode:currencyCode3)
